...
# TradingView-এর অফিসিয়াল লাইভ চার্ট উইজেট এম্বেড (মোবাইল অপ্টিমাইজড)
tradingview_html = f"""
...
"""
# চার্ট উইজেটটি স্ক্রিনে পুশ করা হলো
st.components.v1.html(tradingview_html, height=360)

# ==========================================
# ৩. লরেন্টজিয়ান মেশিন লার্নিং ও প্রব্যাবিলিটি কোর
# ==========================================
np.random.seed(int(time.time()) % 1000)
f1_rsi = np.random.uniform(10, 90, 100)
hist_rsi = f1_rsi[-2] 

# লরেন্টজিয়ান ডিস্টেন্স হিসাব (একক লাইনে ত্রুটিমুক্ত)
